...
import { Provider, Block, FeeData, FixedNumber, HDNodeWallet, Log, ethers, Transaction, TransactionResponse, Filter, Wallet, JsonRpcProvider, AlchemyProvider, InfuraProvider } from 'ethers';
...
export class EthClient implements BaseWallet {
    ...
    static fromPhrase(mnemonic: string, provider?: Provider, path?: string): EthClient{
