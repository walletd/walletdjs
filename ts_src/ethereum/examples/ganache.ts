...
async function doStuff() {
    ...
    let ethClient = EthClient.fromPhrase("black armed enroll bicycle fall finish vague addict estate enact ladder visa tooth sample labor olive annual off vocal hurry half toy bachelor suit", provider, "m/44'/60'/0'/0/1");
