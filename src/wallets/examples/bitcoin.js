...
const regtest_1 = require("../../bitcoin/providers/regtest");
...
(async () => {
    ...
    const rootWallet = new wallets_1.HDWallet("black armed enroll bicycle fall finish vague addict estate enact ladder visa tooth sample labor olive annual off vocal hurry half toy bachelor suit");
    const rootWallet2 = new wallets_1.HDWallet("base federal window toy legal cherry minute wrestle junior tribe gym palace trumpet damage dragon network rude harbor drum attract excess cream wing inquiry");
