...
import { type ChainifyNetwork } from '../types.js';
...
export type CurrenciesInfo = Record<Asset, BN.BigNumber>;
...
export type AssetInfo = { asset: string; type: string; amount: BN.BigNumber };
